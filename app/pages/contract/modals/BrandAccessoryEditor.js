...
const BrandAccessoryEditor = ({ navigation, route: { params } }) => {
  ...
  const [createAccessoryBrand, { data: newAccessory, isLoading, isSuccess }] =
    useCreateAccessoryBrandMutation();

  const [
    updateAccessoryBrand,
...
BrandAccessoryEditor.propTypes = {
...
export default BrandAccessoryEditor;
