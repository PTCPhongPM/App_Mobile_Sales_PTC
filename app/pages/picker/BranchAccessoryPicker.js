...
import { useListAllBranchAccessoriesQuery } from "../../store/api/accessory";

const { TextField } = Incubator;

const BranchAccessoryPicker = ({ navigation, route: { params } }) => {
...
BranchAccessoryPicker.propTypes = {
...
export default BranchAccessoryPicker;
